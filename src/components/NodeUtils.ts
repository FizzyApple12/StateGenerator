import { Position, MarkerType, NodeProps, Node, XYPosition } from "reactflow";

// this helper function returns the intersection point
// of the line between the center of the intersectionNode and the target node
export const getNodeIntersection = (intersectionNode: Node<any>, targetNode: Node<any>) => {
...
export const getEdgePosition = (node: Node<any>, intersectionPoint: XYPosition) => {
...
export const getEdgeParams = (source: Node<any>, target: Node<any>) => {
...
export const flipPosition180 = (position: Position) => flipMap[position];
